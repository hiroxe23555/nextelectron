...
Since an error occurs with npm install due to the dependency of react, delete react from package.json and then npm install
Please install react after npm install